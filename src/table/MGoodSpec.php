...
class MGoodSpec extends MTable
{
    ...
    public function table(Table $table)
    {
        ...
        $table->setComment('商品规格');
        $table->addColumn('title', 'string', ['comment' => '规格名称']);
        $table->addColumn('desc', 'string', ['comment' => '规格描述', 'default' => '']);
        $table->addColumn('icon', 'string', ['comment' => '规格图标', 'default' => '']);
